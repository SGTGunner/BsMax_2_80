...
def add_switch_view(km, space):
	km.new(
		space, 'view3d.perespective', 'P', 'PRESS',
		[('mode', 'Perspective')]
	)

	km.new(
		space, 'view3d.perespective', 'U', 'PRESS',
		[('mode', 'Orthographic')]
	)
...
def add_view3d_tweak_selection(km, space):
	km.new(
		space, 'view3d.select_box', 'LEFTMOUSE', 'CLICK_DRAG',
		[('mode', 'SET')]
	)
...
def add_time(km, space, igoneAnimKey=False):
	...
	km.new(
		space, 'anim.set_key_filters', 'K', 'PRESS', [], ctrl=True, shift=True
	)
...
def add_side_panel(km, space):
	km.new(
		space, 'wm.side_toolbar_toggle', 'LEFT_BRACKET', 'PRESS',
		[('side', 'LEFT')]
	)

	km.new(
		space, 'wm.side_toolbar_toggle', 'RIGHT_BRACKET', 'PRESS',
		[('side', 'RIGHT')]
	)
...
def add_show_types(km, space):
	km.new(
		space, 'view3d.show_types_toggle', 'G', 'PRESS',
		[('mode', 'GEOMETRY')], shift=True
	)

	km.new(
		space, 'view3d.show_types_toggle', 'H', 'PRESS',
		[('mode', 'EMPTY')], shift=True
	)

	km.new(
		space, 'view3d.show_types_toggle', 'S', 'PRESS',
		[('mode', 'CURVE')], shift=True
	)

	km.new(
		space, 'view3d.show_types_toggle', 'L', 'PRESS',
		[('mode', 'LIGHT')], shift=True
	)

	km.new(
		space, 'view3d.show_types_toggle', 'B', 'PRESS',
		[('mode', 'ARMATURE')], shift=True
	)

	km.new(
		space, 'view3d.show_types_toggle', 'C', 'PRESS',
...
def add_float_editors(km, space):
	...
	km.new(
		space, 'editor.float', 'EIGHT', 'PRESS',
		[
			('ui_type', 'ShaderNodeTree'),
			('shader_type', 'WORLD'),
			('multiple', False)
...
def screen(km):
	...
	km.new(
		space, 'screen.screen_full_area', 'X', 'PRESS',
...
def view2d_navigation(km, preferences):
	space = km.space('View2D', 'EMPTY', 'WINDOW')
	km.new(
		space, 'view2d.zoom', 'MIDDLEMOUSE', 'PRESS',
		[], ctrl=True, alt=True
	)
...
def view3d(km, preferences):
	km.mute(
		'3D View', 'view3d.view_center_pick', 'MIDDLEMOUSE', 'CLICK', alt=True
	)

	km.mute(
		'3D View', 'view3d.view_axis', 'MIDDLEMOUSE', 'CLICK_DRAG',
	...
	if preferences.view_undo:
		...
		km.new(
			space, 'view3d.rotatecover', 'MIDDLEMOUSE', 'PRESS', [], alt=True
		)
		...
		km.new(
			space, 'view3d.zoom', 'MIDDLEMOUSE', 'PRESS',
			[], ctrl=True, alt=True
		)
	...
	km.new(
		space, 'view3d.view_axis', 'MIDDLEMOUSE', 'CLICK_DRAG',
		[('type', 'TOP'), ('relative', True)], shift=True, direction='NORTH'
	)

	km.new(
		space, 'view3d.view_axis', 'MIDDLEMOUSE', 'CLICK_DRAG',
		[('type', 'BOTTOM'), ('relative', True)], shift=True, direction='SOUTH'
	)

	km.new(
		space, 'view3d.view_axis', 'MIDDLEMOUSE', 'CLICK_DRAG',
		[('type', 'RIGHT'), ('relative', True)], shift=True, direction='EAST'
	)

	km.new(
		space, 'view3d.view_axis', 'MIDDLEMOUSE', 'CLICK_DRAG',
		[('type', 'LEFT'), ('relative', True)], shift=True, direction='WEST'
	)

	# km.new(space, 'screen.header', 'SIX', 'PRESS', [], alt=True)
	km.new(space, 'screen.region_quadview', 'W', 'PRESS', [], alt=True)
	km.new(
		space, 'view3d.transform_gizmosize', 'EQUAL', 'PRESS', [('step', 10)]
	)

	km.new(
		space, 'view3d.transform_gizmosize', 'MINUS', 'PRESS', [('step', -10)]
	)
	...
	km.new(
		space, 'view3d.select', 'LEFTMOUSE', 'CLICK',
		[
			('extend', True), ('center', True),
			('enumerate', True), ('object',True)
		],
		ctrl=True
	)
	...
	km.new(
		space, 'object.subobject_level', 'B', 'PRESS',
		[('level', 6)], ctrl=True
	)
...
def view3d_select_circle(km):
	...
	space = km.space(v3t, 'VIEW_3D', 'WINDOW')
	km.new(
		space, 'view3d.select_circle', 'LEFTMOUSE', 'CLICK_DRAG',
		[('mode', 'ADD')], ctrl=True
	)
...
def view3d_select_lasso(km):
	...
	km.mute(
		v3t, 'view3d.select_lasso', 'LEFTMOUSE', 'CLICK_DRAG', ctrl=True
	)

	km.new(
		space, 'view3d.select_lasso', 'LEFTMOUSE', 'CLICK_DRAG',
		[('mode', 'ADD')], ctrl=True
	)
...
def object_mode(km, preferences):
	...
	km.mute(
		'Object Mode', 'object.hide_collection', 'ONE', 'PRESS',
		alt=True, ctrl=True, shift=True, any=True
	)

	km.mute(
		'Object Mode', 'object.hide_collection', 'TWO', 'PRESS',
		alt=True, ctrl=True, shift=True, any=True
	)

	km.mute(
		'Object Mode', 'object.hide_collection', 'THREE', 'PRESS',
		alt=True, ctrl=True, shift=True, any=True
	)

	km.mute(
		'Object Mode', 'object.hide_collection', 'FOUR', 'PRESS',
		alt=True, ctrl=True, shift=True, any=True
	)

	km.mute(
		'Object Mode', 'object.hide_collection', 'FIVE', 'PRESS',
		alt=True, ctrl=True, shift=True, any=True
	)

	km.mute(
		'Object Mode', 'object.hide_collection', 'SIX', 'PRESS',
		alt=True, ctrl=True, shift=True, any=True
	)

	km.mute(
		'Object Mode', 'object.hide_collection', 'SEVEN', 'PRESS',
		alt=True, ctrl=True, shift=True, any=True
	)

	km.mute(
		'Object Mode', 'object.hide_collection', 'EIGHT', 'PRESS',
		alt=True, ctrl=True, shift=True, any=True
	)

	km.mute(
		'Object Mode', 'object.hide_collection', 'NINE', 'PRESS',
		alt=True, ctrl=True, shift=True, any=True
	)

	km.mute(
		'Object Mode', 'object.hide_collection', 'ZERO', 'PRESS',
		alt=True, ctrl=True, shift=True, any=True
	)
	...
	km.new(space, 'view3d.drop_tool', 'RIGHTMOUSE', 'PRESS', [])
	km.new(
		space, 'view3d.select', 'LEFTMOUSE', 'RELEASE',
		[('enumerate', True)], shift=True
	)

	km.new(
		space, 'object.select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)

	km.new(
		space, 'object.select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)

	km.new(
		space, 'object.select_all', 'I', 'PRESS',
		[('action', 'INVERT')], ctrl=True
	)

	km.new(
		space, 'object.select_hierarchy', 'PAGE_UP', 'PRESS',
	...
	km.new(
		space, 'object.select_hierarchy', 'PAGE_DOWN', 'PRESS',
	...
	km.new(
		space, 'object.select_similar', 'Q', 'PRESS', [], ctrl=True
	)
	...
	km.new(
		space, 'object.align_selected_to_target', 'A', 'PRESS', [], alt=True
	)
	...
	km.new(
		space, 'object.select_children', 'LEFTMOUSE', 'DOUBLE_CLICK',
		[('full', True)]
	)
	...
	km.new(
		space, 'object.lock_selection_toggle', 'SPACE', 'PRESS', [], alt=True
	)
	km.new(space, 'view3d.show_statistics', 'SEVEN', 'PRESS', [])
...
def mesh(km, preferences):
	...
	km.new(
		space, 'mesh.select_element_toggle', 'FIVE', 'PRESS', [('mode', 'SET')]
	)
	
	km.new(
		space, 'mesh.select_element_setting', 'FIVE', 'PRESS',
		[('mode', 'SET')], ctrl=True
	)

	km.new(space, 'mesh.select_max', 'LEFTMOUSE', 'CLICK', [('mode', 'SET')])
	km.new(
		space, 'mesh.select_max', 'LEFTMOUSE', 'CLICK',
		[('mode', 'ADD')], ctrl=True
	)
	...
	km.new(space, 'view3d.drop_tool', 'RIGHTMOUSE', 'PRESS', [])
	km.new(
		space, 'mesh.select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)

	km.new(
		space, 'mesh.select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)

	km.new(
		space, 'mesh.select_all', 'I', 'PRESS',
		[('action', 'INVERT')], ctrl=True
	)

	km.new(
		space, 'mesh.shortest_path_pick', 'LEFTMOUSE', 'PRESS', [], shift=True
	)

	km.new(
		space, 'mesh.select_more', 'PAGE_UP', 'PRESS',
		[], ctrl=True, repeat=True
	)

	km.new(
		space, 'mesh.select_less', 'PAGE_DOWN', 'PRESS',
		[], ctrl=True, repeat=True
	)

	# km.new(space, 'mesh.smart_select_loop', 'LEFTMOUSE', 'DOUBLE_CLICK', [])
	km.new(
		space, 'mesh.smart_select', 'LEFTMOUSE', 'DOUBLE_CLICK',
		[('mode', 'SET')]
	)
	...
	# Hide/Unhide #
	km.new(
		space, 'mesh.hide_plus', 'H', 'PRESS', [('mode', 'SELECTED')], alt=True
	)

	km.new(
		space, 'mesh.hide_plus', 'I', 'PRESS',
		[('mode', 'UNSELECTED')], alt=True
	)

	km.new(
		space, 'mesh.hide_plus', 'U', 'PRESS', [('mode', 'UNHIDE')], alt=True
	)
	
	# Edit #
	km.new(space, 'mesh.connect', 'E', 'PRESS', [], ctrl=True, shift=True)
	km.new(
		space, 'view3d.edit_mesh_extrude_move_normal', 'E', 'PRESS',
		[], shift=True
	)

	km.new(
		space, 'mesh.knife_tool', 'C', 'PRESS',
	...
	km.new(
		space, 'wm.context_toggle', 'I', 'PRESS',
	...
	km.new(
		space, 'mesh.remove', 'BACK_SPACE', 'PRESS', [('vert', True)], ctrl=True
	)
	...
	km.new(
		space, 'transform.skin_resize', 'A', 'PRESS', [], ctrl=True, shift=True
	)
...
def curve(km, preferences):
	...
	km.new(
		space, 'curve.select_max', 'LEFTMOUSE', 'CLICK',
		[('mode', 'ADD')], ctrl=True
	)
	...
	km.new(space, 'view3d.drop_tool', 'RIGHTMOUSE', 'PRESS', [])
	km.new(
		space, 'curve.select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)

	km.new(
		space, 'curve.select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)

	km.new(
		space, 'curve.select_all', 'I', 'PRESS',
		[('action', 'INVERT')], ctrl=True
	)

	km.new(
		space, 'curve.select_more', 'PAGE_UP', 'PRESS',
		[], ctrl=True, repeat=True
	)

	km.new(
		space, 'curve.select_less', 'PAGE_DOWN', 'PRESS',
		[], ctrl=True, repeat=True
	)
	...
	km.new(
		space, 'curve.break', 'B', 'PRESS', [('action', 'DESELECT')], ctrl=True
	)

	km.new(
		space, 'curve.extrude_move', 'E', 'PRESS',
	...
	km.new(
		space, 'curve.select_linked_pick', 'LEFTMOUSE', 'DOUBLE_CLICK',
		[('deselect', False)]
	)
...
def armature_select_hierarchy_plus(km, space):
	km.new(
	...
	km.new(
		space, 'pose.select_hierarchy_plus', 'PAGE_UP', 'PRESS',
		[('direction', 'PARENT'), ('extend', False)]
	)
	...
	km.new(
		space, 'pose.select_hierarchy_plus', 'PAGE_DOWN', 'PRESS',
...
def armature(km, preferences):
	...
	km.new(space, 'view3d.drop_tool', 'RIGHTMOUSE', 'PRESS', [])
	km.new(
		space, 'armature.select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)

	km.new(
		space, 'armature.select_all', 'D', 'PRESS', 
		[('action', 'DESELECT')], ctrl=True
	)

	km.new(
		space, 'armature.select_all', 'I', 'PRESS',
		[('action', 'INVERT')], ctrl=True
	)

	km.new(
		space, 'armature.select_more', 'PAGE_UP', 'PRESS',
		[], ctrl=True, shift=True, repeat=True
	)

	km.new(
		space, 'armature.select_less', 'PAGE_DOWN', 'PRESS',
		[], ctrl=True, shift=True, repeat=True
	)

	km.new(
		space, 'armature.select_hierarchy', 'PAGE_UP', 'PRESS',
		[('direction', 'PARENT'),('extend',False)]
	)
	...
	km.new(
		space, 'armature.select_hierarchy', 'PAGE_DOWN', 'PRESS',
		[('direction', 'CHILD'),('extend',False)]
	)
	...
	km.new(
		space, 'armature.hide', 'I', 'PRESS', [('unselected',True)], alt=True
	)
	...
	km.new(
		space, 'armature.shortest_path_pick', 'LEFTMOUSE', 'PRESS',
		[], ctrl=True
	) #<<
...
def metaball(km, preferences):
	...
	km.new(space, 'view3d.drop_tool', 'RIGHTMOUSE', 'PRESS', [])
	km.new(
		space, 'mball.select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)

	km.new(
		space, 'mball.select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)

	km.new(
		space, 'mball.select_all', 'I', 'PRESS',
		[('action', 'INVERT')], ctrl=True
	)
...
def lattice(km, preferences):
	...
	km.new(space, 'view3d.drop_tool', 'RIGHTMOUSE', 'PRESS', [])
	km.new(
		space, 'lattice.select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)

	km.new(
		space, 'lattice.select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)

	km.new(
		space, 'lattice.select_all', 'I', 'PRESS',
		[('action', 'INVERT')], ctrl=True
	)
	
	km.new(
		space, 'lattice.select_more', 'PAGE_UP', 'PRESS',
		[], ctrl=True, repeat=True
	)

	km.new(
		space, 'lattice.select_less', 'PAGE_DOWN', 'PRESS',
		[], ctrl=True, repeat=True
	)
...
def weight_paint(km):
	...
	km.new(space, 'view3d.localview', 'Q', 'PRESS', [], alt=True)
	km.new(
		space, 'wm.context_toggle', 'ONE', 'PRESS',
		[('data_path', 'weight_paint_object.data.use_paint_mask_vertex')]
	)

	km.new(
		space, 'wm.context_toggle', 'TWO', 'PRESS',
		[('data_path', 'weight_paint_object.data.use_paint_mask')]
	)

	km.new(
		space, 'paint.vert_select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)

	km.new(
		space, 'paint.vert_select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)

	km.new(
		space, 'paint.vert_select_all', 'I', 'PRESS',
		[('action', 'INVERT')], ctrl=True
	)
	...
	km.new(
		space, 'paint.face_select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)

	km.new(
		space, 'paint.face_select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)

	km.new(
		space, 'paint.face_select_all', 'I', 'PRESS',
		[('action', 'INVERT')], ctrl=True
	)
...
def particle(km):
	...
	km.new(
		space, 'particle.select_max', 'LEFTMOUSE', 'CLICK', [('mode', 'SET')]
	)

	km.new(
		space, 'particle.select_max', 'LEFTMOUSE', 'CLICK',
		[('mode', 'ADD')], ctrl=True
	)
	...
	km.new(
		space, 'particle.select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)

	km.new(
		space, 'particle.select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)

	km.new(
		space, 'particle.select_all', 'I', 'PRESS',
		[('action', 'INVERT')], ctrl=True
	)

	km.new(
		space, 'particle.select_more', 'PAGE_UP', 'PRESS',
		[], ctrl=True, repeat=True
	)

	km.new(
		space, 'particle.select_less', 'PAGE_DOWN', 'PRESS',
		[], ctrl=True, repeat=True
	)
...
def node_editor(km):
	...
	km.new(space, 'wm.multi_item_rename', 'F2', 'PRESS', [])
	km.new(
		space, 'node.select', 'LEFTMOUSE', 'PRESS',
		[('extend', True)], ctrl=True
	)
	 
	km.new(
		space, 'node.select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)
	
	km.new(
		space, 'node.select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)
	
	km.new(
		space, 'node.select_all', 'I', 'PRESS',
		[('action', 'INVERT')], ctrl=True
	)
	...
	km.new(
		space, 'wm.save_as_mainfile', 'S', 'PRESS',
	...
	km.new(
		space, 'wm.call_menu', 'RIGHTMOUSE', 'PRESS',
		[('name', 'NODE_MT_add')]
	)
	...
	km.new(
		space, 'node.duplicate_move_keep_inputs',
		'LEFTMOUSE', 'CLICK_DRAG', 	[], shift=True
	)

	km.new(
		space, 'node.link', 'LEFTMOUSE', 'CLICK_DRAG',
...
def node_editor_fallback(km):
	...
	km.new(
		space, 'node.select_box', 'LEFTMOUSE', 'CLICK_DRAG',
		[('mode', 'ADD')], ctrl=True
	)
	...
	km.new(
		space, 'node.select_lasso', 'LEFTMOUSE', 'CLICK_DRAG',
		[('mode', 'ADD')], ctrl=True
	)
	...
	km.new(
		space, 'node.select_circle', 'LEFTMOUSE', 'CLICK_DRAG',
		[('mode', 'ADD')], ctrl=True
	)
...
def info(km):
	...
	km.new(
		space, 'info.select_box', 'LEFTMOUSE', 'CLICK_DRAG', [('mode', 'SET')]
	)

	km.new(
		space, 'info.select_box', 'LEFTMOUSE', 'CLICK_DRAG',
		[('mode', 'ADD')], ctrl=True
	)
...
def graph_editor(km):
	...
	km.new(
		space, 'graph.select_box', 'LEFTMOUSE', 'CLICK_DRAG',
	...
	km.new(
		space, 'graph.select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)

	km.new(
		space, 'graph.select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)

	km.new(
		space, 'graph.select_all', 'I', 'PRESS',
		[('action', 'INVERT')], ctrl=True
	)

	km.new(
		space, 'graph.select_more', 'PAGE_UP', 'PRESS',
		[], ctrl=True, repeat=True
	)

	km.new(
		space, 'graph.select_less', 'PAGE_DOWN', 'PRESS',
		[], ctrl=True, repeat=True
	)
...
def dopesheet_editor(km):
	...
	km.new(
		space, 'anim.set_timeline_range', 'LEFTMOUSE', 'PRESS',
		[('mode', 'First')], alt=True, ctrl=True
	)

	km.new(
		space, 'anim.set_timeline_range', 'RIGHTMOUSE', 'PRESS',
		[('mode', 'End')], alt=True, ctrl=True
	)

	km.new(
		space, 'anim.set_timeline_range', 'MIDDLEMOUSE', 'PRESS',
	...
	km.new(
		space, 'action.select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)

	km.new(
		space, 'action.select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)

	km.new(
		space, 'action.select_all', 'I', 'PRESS',
		[('action', 'INVERT')], ctrl=True
	)

	km.new(
		space, 'action.select_more', 'PAGE_UP', 'PRESS',
		[], ctrl=True, repeat=True
	)

	km.new(
		space, 'action.select_less', 'PAGE_DOWN', 'PRESS',
		[], ctrl=True, repeat=True
	)
	...
	km.new(
		space, 'action.select_box', 'LEFTMOUSE', 'CLICK_DRAG',
		[('mode', 'ADD')], ctrl=True
	)
...
def nla_editor(km):
	...
	km.mute(
		'NLA Editor', 'nla.select_box', 'LEFTMOUSE', 'CLICK_DRAG', ctrl=True
	)

	km.new(
		space, 'nla.select_box', 'LEFTMOUSE', 'CLICK_DRAG',
		[("mode", 'ADD')], ctrl=True
	)
...
def clip_editor(km):
	km.mute(
		'Clip Editor', 'clip.add_marker_slide', 'LEFTMOUSE', 'PRESS', ctrl=True
	)
	...
	km.new(
		space, 'clip.select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)

	km.new(
		space, 'clip.select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)
	...
	km.new(
		space, 'clip.select_box', 'LEFTMOUSE', 'CLICK_DRAG', [('mode', 'SET')]
	)

	km.new(
		space, 'clip.select_box', 'LEFTMOUSE', 'CLICK_DRAG',
		[('mode', 'ADD')], ctrl=True
	)
...
def uv_editor(km, preferences):
	...
	km.new(
		space, 'uv.select', 'LEFTMOUSE', 'PRESS',
		[('extend', True)], ctrl=True
	)
	...
	km.new(
		space, 'uv.shortest_path_pick', 'LEFTMOUSE', 'PRESS', [], shift=True
	)

	km.new(
		space, 'uv.shortest_path_pick', 'LEFTMOUSE', 'PRESS',
		[('extend', True)], ctrl=True, shift=True
	)

	km.new(space, 'uv.select_loop', 'LEFTMOUSE', 'DOUBLE_CLICK', [])
	km.new(
		space, 'uv.select_loop', 'LEFTMOUSE', 'DOUBLE_CLICK',
		[('extend', True)], ctrl=True
	)

	km.new(
		space, 'uv.select_more', 'PAGE_UP', 'PRESS',
		[], ctrl=True, repeat=True
	)

	km.new(
		space, 'uv.select_less', 'PAGE_DOWN', 'PRESS',
		[], ctrl=True, repeat=True
	)

	km.new(
		space, 'uv.select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)

	km.new(
		space, 'uv.select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)

	km.new(
		space, 'uv.select_all', 'I', 'PRESS',
		[('action', 'INVERT')], ctrl=True
	)

	# Note: multi loop command not working on uv yet
	km.new(
		space, 'uv.select_loop', 'L', 'PRESS',
		[('extend', True)], alt=True
	)

	km.new(
		space, 'uv.select_edge_ring', 'R', 'PRESS',
		[('extend', True)], alt=True
	)
	...
	km.new(
		space, 'uv.select', 'LEFTMOUSE', 'CLICK_DRAG', [('extend', True)]
	)

	km.new(
		space, 'uv.select_box', 'LEFTMOUSE', 'CLICK_DRAG', [('mode', 'SET')]
	)

	km.new(
		space, 'uv.select_box', 'LEFTMOUSE', 'CLICK_DRAG',
		[('mode', 'ADD')], ctrl=True
	)
	...
	km.new(
		space, 'uv.select_box', 'LEFTMOUSE', 'ANY',
		[('mode', 'ADD')], ctrl=True
	)
	...
	km.new(
		space, 'uv.select_circle', 'LEFTMOUSE', 'CLICK_DRAG',
		[('mode', 'ADD')], ctrl=True
	)
	...
	km.new(
		space, 'uv.select_lasso', 'LEFTMOUSE', 'CLICK_DRAG',
		[('mode', 'ADD')], ctrl=True
	)
...
def sequence_editor(km):
	...
	km.new(
		space, 'sequencer.select_box', 'LEFTMOUSE', 'CLICK_DRAG',
		[(('mode', 'ADD'))], ctrl=True
	)
...
def file_browser(km):
	...
	km.new(
		space, 'file.directory_new', 'N', 'PRESS', [], ctrl=True, shift=True
	)
	
	km.new(
		space, 'filebrowser.scaleicons', 'WHEELUPMOUSE', 'PRESS',
		[('up', True)], ctrl=True
	)
	
	km.new(
		space, 'filebrowser.scaleicons', 'WHEELDOWNMOUSE', 'PRESS',
		[('up', False)], ctrl=True
	)
	
	km.new(
		space, 'file.select_all', 'A', 'PRESS',
		[('action', 'SELECT')], ctrl=True
	)
	
	km.new(
		space, 'file.select_all', 'D', 'PRESS',
		[('action', 'DESELECT')], ctrl=True
	)
